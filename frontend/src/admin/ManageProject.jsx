    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500 mt-1">Create, edit, and manage your portfolio projects</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        {paginatedProjects.length === 0 ? (
          <div className="text-center py-8 sm:py-12 px-4">
            ...
            <h3 className="text-base sm:text-lg font-medium text-gray-800 mb-2">No projects found</h3>
            ...
            <div className="relative bg-white rounded-xl sm:rounded-2xl w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
              ...
              <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Client *</label>
                    <input
                      type="text"
                      name="client"
                ...
                <div>
                  ...
                  {formData.image && (
                    <div className="mt-2">
                      <img src={formData.image} alt="Preview" className="h-16 sm:h-20 w-auto rounded-lg object-cover" />
                    </div>
                  )}
                </div>
                ...
                {/* Key Findings */}
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Key Findings</label>
                  <textarea
                    name="keyFindings"
                ...
                {/* Outcomes */}
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Project Outcomes</label>
                  <textarea
                    name="outcomes"
